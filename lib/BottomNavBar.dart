...
import 'package:nectar/Favorites.dart';
import 'package:nectar/Home.dart';
import 'package:nectar/My%20Cart.dart';
...
final screens = [Home(), Explore(), MyCart(), Favorites(), Account()];
int selectedIndex = 0;
          ...
          items: [
            BottomNavigationBarItem(
                icon: selectedIndex == 0
                    ? Column(
                        children: [
                          Icon(Icons.storefront_rounded,color: Colors.green,),
                          Text(
                            'Shop',
                            style: TextStyle(
                              color: Colors.green,
                    ...
                    : Column(
                      children: [
                        Icon(Icons.storefront_outlined), Text(
                          'Shop',
                          style: TextStyle(
                            color: Colors.black,
                            fontSize: 12.sp,
            ...
            BottomNavigationBarItem(
                icon: selectedIndex == 1
                  ...
                  children: [
                    ...
                    : Column(
                  children: [
                    Icon(Icons.manage_search_outlined), Text(
                      'Explore',
                      style: TextStyle(
                        color: Colors.black,
                        fontSize: 12.sp,
            ...
            BottomNavigationBarItem(
                icon: selectedIndex == 4
                  ...
                  children: [
                    ...
                    : Column(
                  children: [
                    Icon(Icons.person_outline_rounded), Text(
                      'Account',
                      style: TextStyle(
                        color: Colors.black,
                        fontSize: 12.sp,
